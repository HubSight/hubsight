...
func (_q *CameraQuery) QueryRecordings() *RecordingQuery {
...
func (_q *CameraQuery) WithRecordings(opts ...func(*RecordingQuery)) *CameraQuery {
	query := (&RecordingClient{config: _q.config}).Query()
...
func (_q *CameraQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Camera, error) {
	...
	if query := _q.withRecordings; query != nil {
		if err := _q.loadRecordings(ctx, query, nodes,
			func(n *Camera) { n.Edges.Recordings = []*Recording{} },
			func(n *Camera, e *Recording) { n.Edges.Recordings = append(n.Edges.Recordings, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
