...
type RecognitionLog struct {
	...
	CameraID      string            `gorm:"column:camera_id;type:varchar(21);not null;index:recognitionlog_camera_id_created_at,priority:1" json:"camera_id,omitempty"`
	...
	CreatedAt     time.Time         `gorm:"column:created_at;not null;default:CURRENT_TIMESTAMP;index:recognitionlog_camera_id_created_at,priority:2" json:"created_at,omitempty"`
}
