...
type MemberFace struct {
	...
	MemberID       string    `gorm:"column:member_id;type:varchar(21);not null;index:idx_member_faces_member_id;index:idx_member_faces_member_active,priority:1" json:"member_id,omitempty"`
	...
	IsActive       bool      `gorm:"column:is_active;not null;default:true;index:idx_member_faces_member_active,priority:2" json:"is_active"`
