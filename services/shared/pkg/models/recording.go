...
type Recording struct {
	...
	CameraID        string    `gorm:"column:camera_id;type:varchar(21);not null;index" json:"camera_id,omitempty"`
	...
	FilePath        string    `gorm:"column:file_path;type:text;uniqueIndex;not null" json:"file_path,omitempty"`
