...
type Recording struct {
	...
	CameraID        string    `gorm:"column:camera_id;type:varchar(21);not null;index:idx_recordings_camera_id;index:idx_recordings_camera_start,priority:1" json:"camera_id,omitempty"`
	StartAt         time.Time `gorm:"column:start_at;not null;index:idx_recordings_start_at;index:idx_recordings_camera_start,priority:2" json:"start_at,omitempty"`
	EndAt           time.Time `gorm:"column:end_at;not null;index:idx_recordings_end_at" json:"end_at,omitempty"`
