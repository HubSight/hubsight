            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2.5 sm:gap-3">
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 sm:gap-3 flex-1 max-w-2xl">
                ...
                <Select
                  ...
                  className="sm:min-w-[220px] shrink-0"
                  options={[
                    { value: 'all', label: t('clients.allPlatforms') },
                    { value: 'mobile', label: t('clients.platformMobile') },
                    { value: 'web_spa', label: t('clients.platformWeb') },
                    { value: 'third_party', label: t('clients.platformThirdParty') },
                  ]}
                />
              </div>
