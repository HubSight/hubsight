    ...
    <PullToRefresh onRefresh={fetchMembers} className="h-full bg-slate-50/50 dark:bg-slate-950/50 overflow-y-auto">
      <div className="max-w-7xl mx-auto p-4 md:p-6 lg:p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
          <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-emerald-200/80 dark:border-emerald-800/60 shadow-xs flex items-center gap-3">
            ...
            <div>
              <div className="text-xs font-bold text-slate-800 dark:text-slate-200">{t('members.roleFamily')}</div>
              <div className="text-[11px] text-emerald-600 dark:text-emerald-400 font-medium">{t('members.familyCount', { count: familyCount })}</div>
            </div>
          </div>

          <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-blue-200/80 dark:border-blue-800/60 shadow-xs flex items-center gap-3">
            ...
            <div>
              <div className="text-xs font-bold text-slate-800 dark:text-slate-200">{t('members.roleNeighbor')}</div>
              <div className="text-[11px] text-blue-600 dark:text-blue-400 font-medium">{t('members.guestCount', { count: guestCount })}</div>
            </div>
          </div>

          <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-amber-200/80 dark:border-amber-800/60 shadow-xs flex items-center gap-3">
            ...
            <div>
              <div className="text-xs font-bold text-slate-800 dark:text-slate-200">{t('members.roleStranger')}</div>
              <div className="text-[11px] text-amber-600 dark:text-amber-400 font-medium">{t('members.roleStrangerDesc')}</div>
            </div>
          </div>

          <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-purple-200/80 dark:border-purple-800/60 shadow-xs flex items-center gap-3">
            ...
            <div>
              <div className="text-xs font-bold text-slate-800 dark:text-slate-200">{t('members.roleStaffBanner')}</div>
              <div className="text-[11px] text-purple-600 dark:text-purple-400 font-medium">{t('members.roleStaffBannerDesc')}</div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 bg-white dark:bg-slate-900 p-3 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-xs">
          <div className="relative w-full sm:w-80">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 bg-slate-50 dark:bg-slate-800/70 border border-slate-200/80 dark:border-slate-700 rounded-xl text-xs text-slate-800 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:bg-white dark:focus:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all"
            />
          </div>
        ...
        {isLoading ? (
          ...
          <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200/80 dark:border-slate-800 p-12 text-center flex flex-col items-center justify-center gap-3">
