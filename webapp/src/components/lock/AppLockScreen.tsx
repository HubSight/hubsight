...
export const AppLockScreen: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-slate-100/95 backdrop-blur-2xl flex flex-col items-center justify-center p-4 sm:p-6 pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)] pl-[env(safe-area-inset-left)] pr-[env(safe-area-inset-right)] text-slate-800 select-none animate-fade-in">
      {/* Main Lock Card */}
