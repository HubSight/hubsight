...
export const PullToRefresh: React.FC<PullToRefreshProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex items-center gap-2 px-3 py-1.5 rounded-md bg-white border border-slate-200 shadow-md text-xs font-semibold text-slate-700 transform">
          {isRefreshing ? (
            <>
