...
import { FFMPEG_PRESET_TAGS } from '../../constants/cameraPresets';

interface CameraFfmpegTabProps {
...
const VIDEO_CODECS = [
  {
    ...
    badge: '0% CPU',
    desc: 'Preserves camera stream quality with zero server CPU re-encoding overhead.'
  },
  {
    id: 'h264',
...
const AUDIO_MODES = [
  ...
  },
  {
    ...
    title: 'Direct Copy',
    badge: 'Direct Copy',
    desc: 'Preserves incoming raw audio stream directly from camera without changes.'
  },
  {
    id: 'aac',
    title: 'Encode AAC',
...
export const CameraFfmpegTab: React.FC<CameraFfmpegTabProps> = ({
  formData,
  onChange,
  onAddFfmpegTag
}) => {
